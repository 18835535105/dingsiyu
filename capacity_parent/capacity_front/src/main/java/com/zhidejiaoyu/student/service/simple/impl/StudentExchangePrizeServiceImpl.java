...
import com.zhidejiaoyu.student.service.simple.IStudentExchangePrizeService;
 ...
 */
@Service
public class StudentExchangePrizeServiceImpl extends BaseServiceImpl<StudentExchangePrizeMapper, StudentExchangePrize> implements IStudentExchangePrizeService {
    ...
    public ServerResponse<Object> getAllList(HttpSession session) {
        ...
        String string = campusMapper.selSchoolName(teacherId);
