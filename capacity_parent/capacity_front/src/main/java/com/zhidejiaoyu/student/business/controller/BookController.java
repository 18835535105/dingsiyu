...
public class BookController {
    ...
    public ServerResponse<PageInfo<BookVo>> getWordBookList(HttpSession session, String unitId, String studyModel,
        ...
        return bookService.getWordBookList(session, unitId, studyModel, condition);
    }
