 ...
 */
@Service
public class GauntletServiceImpl extends BaseServiceImpl<GauntletMapper, Gauntlet> implements IGauntletService {
        ...
        if (type == 1) {
            ...
            if (isDelete == 2) {
                ...
                if (gauntlet.getChallengerPoint() - point > 0) {
                    List<Map<String, Object>> maps = awardMapper.selAwardCountByStudentId(challengerStudnet.getId());
