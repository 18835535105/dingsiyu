 ...
 */
@Controller
@RequestMapping("/api/syntheticRewardsList")
public class SimpleSyntheticRewardsListController {

    @Autowired
    private SimpleSyntheticRewardsListServiceSimple syntheticRewardsListService;
