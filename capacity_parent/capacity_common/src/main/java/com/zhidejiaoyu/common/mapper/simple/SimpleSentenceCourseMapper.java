 ...
 * @since 2019-03-29
 */
public interface SimpleSentenceCourseMapper extends BaseMapper<SentenceCourse> {
     ...
     * @return
     */
    @Select("select id from sentence_course where version = #{version} and grade = #{grade} and label = #{label} and delStatus = 1")
