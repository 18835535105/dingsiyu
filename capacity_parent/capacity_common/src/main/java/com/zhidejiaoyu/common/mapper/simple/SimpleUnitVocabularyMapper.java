...
public interface SimpleUnitVocabularyMapper {
    ...
    Integer allCountWord(@Param("unitId") Integer unitId);
     ...
     * @return
     */
    Long countWordByUnitIds(@Param("unitIds") List<Long> unitIds);
    ...
    @MapKey("id")
	Map<Long, Map<Long, String>> selectWordChineseMapByCourseIdIdAndWordIds5DTest(@Param("idSet") Set<Long> idSet, @Param("start") String start,
