 ...
 * 记忆强度，黄金记忆点
 * 0%-10%,	本单词最后一次学习结束+0s，
 * 10%-20%，本单词最后一次学习结束+10s，
 * 20%-30%，本单词最后一次学习结束+1分钟，
 * 30%-40%，本单词最后一次学习结束+7分钟，
 * 40%-50%，本单词最后一次学习结束+60分钟
 * 50%-60%，本单词最后一次学习结束+2小时
 * 60%-70%，本单词最后一次学习结束+6小时
 * 70%-80%，本单词最后一次学习结束+1天后
 * 80%-90%，本单词最后一次学习结束+2天后
 * 90%-100%，本单词最后一次学习结束+3天后
 */
@Component
public class GoldMemoryTime {
     ...
     * 获取黄金记忆点
     *
     * @param memoryStrength 记忆强度,学习本单词之前的记忆强度。（在更新本次记忆追踪之前获取到的记忆强度）
     * @param studyEnd       本单词最后学习结束时间
     * @return 黄金记忆点
     */
