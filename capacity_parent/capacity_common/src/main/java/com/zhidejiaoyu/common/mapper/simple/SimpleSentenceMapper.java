...
public interface SimpleSentenceMapper extends BaseMapper<Sentence> {
     ...
     *
     * @param id    例句id
     * @param phase 学段 高中/初中
     * @return
     */
    String selectChineseByIdAndPhase(@Param("id") Long id, @Param("phase") String phase);
